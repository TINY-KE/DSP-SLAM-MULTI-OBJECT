...
# object_classes_on_ground = ["chair", "dining table"]  #for 7 floor

# object_classes_on_ground = ["chair", "dining table", "couch"]  #for ruihai_charpt5 - 1 
# object_classes_on_ground = ["couch", "bed"]  #for ruihai_charpt5 - 1 
object_classes_on_ground = ["cake"]  #for ruihai_charpt5 用于餐桌
object_classes_on_ground = ["chair"]  #for ruihai_charpt5 用于两把椅子
object_classes_on_ground = ["couch"]  #for ruihai_charpt5 用于沙发
object_classes_on_ground = ["dining table",  "monitor"]  #for ruihai_charpt5 用于书桌和显示器
object_classes_on_ground = ["dining table"]  #for ruihai_charpt5 用于书桌 或 餐桌
# object_classes_on_ground = ["bed"]  #for ruihai_charpt5 用于床
